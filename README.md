# hmpps-domain-explorer-api

[![Ministry of Justice Repository Compliance Badge](https://github-community.service.justice.gov.uk/repository-standards/api/hmpps-domain-explorer-api/badge?style=flat)](https://github-community.service.justice.gov.uk/repository-standards/hmpps-domain-explorer-api)
[![Docker Repository on ghcr](https://img.shields.io/badge/ghcr.io-repository-2496ED.svg?logo=docker)](https://ghcr.io/ministryofjustice/hmpps-domain-explorer-api)
[![API docs](https://img.shields.io/badge/API_docs_-view-85EA2D.svg?logo=swagger)](https://domain-explorer-api-dev.hmpps.service.justice.gov.uk/swagger-ui/index.html)
...
Our security policy is located [here](https://github.com/ministryofjustice/hmpps-domain-explorer-api/security/policy).
...
## Renaming from HMPPS Domain Explorer Api - github Actions
...
```bash
docker compose pull && docker compose up --scale hmpps-domain-explorer-api=0
```
